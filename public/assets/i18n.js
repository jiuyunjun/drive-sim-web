...
const TRANSLATIONS = {
  zh: {
    ...
    controls: {
      ...
      hapticMode: '启用震动反馈',
      hapticHelp: '行驶时用轻微短震动模拟路面颠簸，频率随车速线性增加；转向和松开刹车不震动。',
  ...
  en: {
    ...
    controls: {
      ...
      hapticMode: 'Enable haptic feedback',
      hapticHelp: 'Light road bumps increase linearly with speed; steering and brake release do not vibrate.',
  ...
  ja: {
    ...
    controls: {
      ...
      hapticMode: '振動フィードバックを有効にする',
      hapticHelp: '路面の振動頻度は速度に比例して増えます。ステアリング操作とブレーキを離した時は振動しません。',
