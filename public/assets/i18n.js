...
const TRANSLATIONS = {
  zh: {
    ...
    controls: {
      ...
      hapticHelp: '行驶时用轻微短震动模拟路面颠簸：低速较疏，高速略密；停车不震动，换挡反馈保留。',
  ...
  en: {
    ...
    controls: {
      ...
      hapticHelp: 'Light road bumps while moving: slower at low speed, slightly faster at high speed. No bumps at rest; shift feedback remains.',
  ...
  ja: {
    ...
    controls: {
      ...
      hapticEvents: '操作時のみ',
      hapticRoad: '路面の振動 + 操作',
      hapticHelp: '走行中は軽い振動で路面の凹凸を表現。低速では間隔を長く、高速では少し短くします。停車中は振動せず、変速時の振動は維持します。',
