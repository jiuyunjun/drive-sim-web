...
const TRANSLATIONS = {
  zh: {
    ...
    controls: {
      ...
      hapticOff: '关闭',
      hapticEvents: '操作反馈',
      hapticEngine: '引擎 + 操作反馈',
      hapticHelp: '行驶时短脉冲模拟引擎，换挡时较长脉冲。震感取决于设备。',
  ...
  en: {
    ...
    controls: {
      ...
      hapticEngine: 'Engine + driving events',
      hapticHelp: 'Short pulses while driving simulate the engine; longer pulses mark shifts. Feel varies by device.',
  ...
  ja: {
    ...
    controls: {
      ...
      hapticOff: 'オフ',
      hapticEvents: '操作時のみ',
      hapticEngine: 'エンジン + 操作',
      hapticHelp: '走行中の短い振動でエンジン、長めの振動で変速を表現します。感触は端末により異なります。',
